...
% todo(any) add an airfoilID enumeration class
    ...
    if af == 'S814' 
        ...
        AoA_cd = [-180.1;-130;-90;-30;-26;-10;-2;0;19;21;46;90;128;180];
        CD = [0.0797;1.2065;2.3162;0.43284;0.25791;0.12041;0.069511;0.054681;0.18731;0.38311;1.2171;2.3866;1.2507;0.0797]; 
        clcurve = [AoA_cl';CL'];
        cdcurve = [AoA_cd';CD'];
    ...
    elseif af == 'NACA0015' % NACA0015
        % todo this is same as SG6040 - fix it
        AoA_cl = [-180.1;-172.2;-161.3;-140.1;-92.15;-44.9;-13.6;-11.78;0;11.78;13.6;44.9;92.15;140.1;161.3;172.2;180.1];
        CL = [0;0.827;0.609;0.946;0;-1.07;-0.49;-0.927;0;0.927;0.49;1.07;0;-0.946;-0.609;-0.827;0];
        AoA_cd = [-180.1;-175;-167;-158;-130.9;-90;-30.1;-13.04;-11.78;0;11.78;13.04;30.1;90;130.9;158;167;175;180.1];
        CD = [0.0387;0.044;0.223;0.354;1.251;1.867;0.617;0.163;0.052;0.028;0.052;0.163;0.617;1.867;1.251;0.354;0.223;0.044;0.0387]; 
        clcurve = [AoA_cl';CL'];
        cdcurve = [AoA_cd';CD'];
        cmcurve = [AoA_cl';cm0*ones(size(AoA_cl'))]; % todo(rodney) change this when(if) you find cm curve data
