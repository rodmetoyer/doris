...
cosfi3 = cos(x(14)); sinfi3 = sin(x(14));
cossy3 = cos(x(16)); sinsy3 = sin(x(16));
...
% No assumptions
% tauMinusCvec(1) =  f1 + (x(8)*(s1*x(8) - s2*x(7)) + x(9)*(s1*x(9) - s3*x(7)))*(m1 + m2 + mv) + (x(11)*x(9) - x(12)*x(8))*(m1 + m2 + mv);
% tauMinusCvec(2) =  f2 - (x(7)*(s1*x(8) - s2*x(7)) - x(9)*(s2*x(9) - s3*x(8)))*(m1 + m2 + mv) - (x(10)*x(9) - x(12)*x(7))*(m1 + m2 + mv);
% tauMinusCvec(3) =  f3 - (x(7)*(s1*x(9) - s3*x(7)) + x(8)*(s2*x(9) - s3*x(8)))*(m1 + m2 + mv) + (x(10)*x(8) - x(11)*x(7))*(m1 + m2 + mv);
