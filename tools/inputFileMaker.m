...
leewardInductionFctors = 0.4; %[0.4 0.6 0.8 1.0];
...
for i1=1:1:length(relativeDensities)
    for i2=1:1:length(ballastZLocationsPrcnt)
        for i3=1:1:length(windwardInductionFactors)
            for i4=1:1:length(leewardInductionFctors)
                ...
                fprintf(inputFileID,'%s\n','initialYaw = -8.5*pi/180;');
                fprintf(inputFileID,'%s\n','initialPitch = 80*pi/180;');
                fprintf(inputFileID,'%s\n','initialRoll = 0*pi/180;');
                fprintf(inputFileID,'%s\n','initialLateral = 31;');
                fprintf(inputFileID,'%s\n','initialLongitudinal = tunstrch;');
                fprintf(inputFileID,'%s\n','initialVertical = 34;');
                fprintf(inputFileID,'%s\n','initialSway = 0;');
                fprintf(inputFileID,'%s\n','initialSurge = 0;');
                fprintf(inputFileID,'%s\n','initialHeave = 0;');
