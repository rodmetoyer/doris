...
numSections1 = 14;       % Number of sections (whole number)
...
numSections2 = 14;       % Number of sections (whole number)
...
rot2ornt = [0;0;0];
rot1initRPM = 10;
rot2initRPM = -5; % sign for directionality
addedMass = [];
rotorVisc = 0.02; % viscous friction coeffiecient between rotors and body
vtMod = 10.0;      % to modify the torsional viscosity constant (cm - cylinder moment coefficient) 
